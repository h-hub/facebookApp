...
stickerApi.get('/', function(req, res, next){
    res.send('stickerApi server is working fine');
});

stickerApi.get('/getStocks', function(req, res) {
    res.send(stocks);
});

stickerApi.get('/getPrevStocks', function(req, res) {
    res.send(prevValues);
});

stickerApi.locals.regSocket = function(io){
...
stickerApi.locals.attributes = {
    name: plugin.name,
    version: plugin.version,
    prefix: plugin.prefix
};

module.exports = stickerApi;